  ...
  return (
    <>
      <DeleteDialog
        ...
        DeleteFlag={1}
      />
      <RenameDialog open={openRenameDialog} handleClose={handleRenameDialogClose} id={id} name={name} RenameFlag={1} Title={"Rename playlist"}/>
      <ContextMenu.Root>
          ...
          >
            <ContextMenu.Sub>
              <ContextMenu.SubTrigger
               className="flex items-center outline-none px-3 py-2 rounded-md hover:bg-gray-700 cursor-default"
              >
                Move to folder
              ...
              <ContextMenu.Portal>
                <ContextMenu.SubContent className="bg-gray-800 text-slate-50 min-w-[220px] rounded-md p-1"
                alignOffset={-1}
                sideOffset={0}
                >
                <ContextMenu.Item
            ...
            <ContextMenu.Item
              className="outline-none px-3 py-2 rounded-md hover:bg-gray-700 cursor-default"
              onSelect={handleOpen}
            >
              Delete
            </ContextMenu.Item>
            <ContextMenu.Separator className="h-[1px] my-[2px] mx-[1px] bg-gray-700" />
            <ContextMenu.Item onSelect={handleRenameDialogOpen} className="outline-none px-3 py-2 rounded-md hover:bg-gray-700 cursor-default">
              Rename
            </ContextMenu.Item>
            <ContextMenu.Item className="outline-none px-3 py-2 rounded-md hover:bg-gray-700 cursor-default">
              Share
            </ContextMenu.Item>
          </ContextMenu.Content>
        </ContextMenu.Portal>
